...
VARIABLES
 ...
 ue_emergency_number_set, 
 amf_home0_emergency_number_set, 
 amf_home1_emergency_number_set, 
 amf_roam0_emergency_number_set, 
 amf_roam1_emergency_number_set, 
 amf_emergency_number_set, 

 
 ue_attach_request_message, 
 ue_detach_request_message, 
 amf_attach_accept_message, 
 ue_emergency_setup_message, 
 amf_call_connect_message, 
 ...
 amf_0_normal_attach_accept_include_enl, 
 amf_1_normal_attach_accept_include_enl, 
 amf_0_emergency_attach_accept_include_enl, 
 amf_1_emergency_attach_accept_include_enl, 
 amf_home_reject_or_allow_unmarked_emergency_request, 
 amf_roam_reject_or_allow_unmarked_emergency_request, 
 amf_home_route_with_type_or_number, 
 amf_roam_route_with_type_or_number, 
 amf_home_require_emergency_registration_for_emergency_session 
...
UE_FIXED_EMERGENCY_NUMBER_SET == {"911"} 
...
TypeInvariant ==
        ...
        /\ amf_attach_accept_message \in [emergency_number_list: SUBSET NUMBER_CANDIDATES_SET, mnc : MNC_CANDIDATES_SET] 
        /\ ue_emergency_setup_message \in [number: (NUMBER_CANDIDATES_SET \ {"0"}), category: CATEGORY_SET] 
        ...
        /\ pc_UE \in {"ue_emm_deregistered", "ue_emm_registered_initiated", "ue_emm_registered", "ue_call_initiated", "ue_refuse_call"}
        /\ pc_AMF \in {"amf_emm_deregistered", "amf_emm_registered", "amf_call_release"} 
        /\ ue_current_mnc \in MNC_CANDIDATES_SET 
...
UE_reboot ==
        /\ \/ /\ ue_sim_card_present = 1
              /\ ue_emergency_number_set = UNION { UE_FIXED_EMERGENCY_NUMBER_SET, amf_home1_emergency_number_set, NON_EMERGENCY_NUMBER_CANDIDATES_SET} 
           \/ /\ ue_sim_card_present = 0
              /\ ue_emergency_number_set = UNION { UE_FIXED_EMERGENCY_NUMBER_SET, UE_ME_EMERGENCY_NUMBER_SET, NON_EMERGENCY_NUMBER_CANDIDATES_SET} 
        /\ user_make_call = 0
        /\ ue_dial_emergency = 0
        /\ user_dial_number = "0"
...
USER_make_call == 
        ...
        /\ user_make_call' = 1
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, pc_UE, routed_psap, ue_attach_request_message, ue_current_mnc, ue_detach_request_message, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present >>


UE_send_normal_attach_request ==
        /\ pc_UE = "ue_emm_deregistered"
        /\ ue_attach_request_message' = [ue_attach_request_message EXCEPT !.type = "normal"]
        /\ pc_UE' = "ue_emm_registered_initiated"
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_current_mnc, ue_detach_request_message, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
UE_send_emergency_attach_request ==
        ...
        /\  \/  /\ pc_UE /= "ue_emm_registered"
                ...
                /\ ue_attach_request_message' = [ue_attach_request_message EXCEPT !.type = "emergency"]
                /\ pc_UE' = "ue_emm_registered_initiated"
                /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_current_mnc, ue_detach_request_message, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
UE_send_detach_request_for_emergency ==
        ...
        /\ amf_call_connect_message' = 0
        /\ pc_UE' = "ue_emm_deregistered"
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_attach_request_message, ue_current_mnc, ue_detach_request_message, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
AMF_send_attach_response == 
        ...
        /\ amf_emergency_number_set' = 
            ...
            [] code = "roam0" -> amf_roam0_emergency_number_set
            [] code = "roam1" -> amf_roam1_emergency_number_set
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_UE, routed_psap, ue_attach_request_message, ue_current_mnc, ue_detach_request_message, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
UE_send_attach_complete ==
        ...
        /\  \/  /\ ue_sim_card_present = 1   
                ...
                /\  \/  /\  \/  /\  ue_current_mnc \in HOME_MNC_CANDIDATES_SET
                        ...
                        /\ ue_emergency_number_set' = UNION {ue_emergency_number_set, amf_home1_emergency_number_set} 
        ...
        /\ pc_UE' = "ue_emm_registered"
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_attach_request_message, ue_detach_request_message, ue_dial_emergency, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
UE_hang_up ==
        ...
        /\ ue_dial_emergency' = 0
        /\ pc_UE' = "ue_emm_registered"
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_attach_request_message, ue_current_mnc, ue_detach_request_message, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_dial_number >>
...
UE_send_setup ==
        ...
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_AMF, routed_psap, ue_attach_request_message, ue_current_mnc, ue_emergency_number_set, ue_sim_card_present, user_make_call, user_dial_number >>
...
AMF_send_call_response ==
        ...
        /\ pc_AMF' = "amf_call_release"
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_UE, ue_attach_request_message, ue_current_mnc, ue_detach_request_message, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
...
AMF_send_detach_accept ==
        ...
        /\ UNCHANGED << amf_home_require_emergency_registration_for_emergency_session, amf_attach_accept_message, amf_call_connect_message, amf_call_failure_message, amf_0_emergency_attach_accept_include_enl, amf_1_emergency_attach_accept_include_enl, amf_home0_emergency_number_set, amf_home1_emergency_number_set, amf_roam0_emergency_number_set, amf_roam1_emergency_number_set, amf_emergency_number_set, amf_home_reject_or_allow_unmarked_emergency_request, amf_home_route_with_type_or_number, amf_0_normal_attach_accept_include_enl, amf_1_normal_attach_accept_include_enl, amf_roam_reject_or_allow_unmarked_emergency_request, amf_roam_route_with_type_or_number, pc_UE, routed_psap, ue_attach_request_message, ue_current_mnc, ue_dial_emergency, ue_emergency_number_set, ue_emergency_setup_message, ue_sim_card_present, user_make_call, user_dial_number >>
